...
Challenge  2
To do challenge 2 i have created a virutal machine on azure using the rest api querying VMs metadata in json format

Request.txt

 Login to the Azure subscirption and create a VM
